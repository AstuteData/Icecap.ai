...
def run_proxycurl(company_id, li_company_profile_url, research_id, user_id):
...
def format_proxycurl_response(r, general_company_completion, company_id, research_id, user_id):
