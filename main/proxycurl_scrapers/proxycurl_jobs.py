...
def run_proxycurl(job_list, company_id, research_id, user_id):
    formatted_job_list = []
    job_counter = 0
    for job in job_list:
    ...
    completion = format_proxycurl_response(job_data_list, company_id, research_id, user_id)
...
def format_proxycurl_response(job_data_list, company_id, research_id, user_id):
    ...
    try:
        for job in job_data_list:
            ...
            temp_job_dataframe['user_id'] = user_id
